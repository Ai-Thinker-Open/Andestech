...
OUTPUT_ARCH(nds32)
ENTRY(_start)
SEARCH_DIR("/NOBACKUP/sqa14/sqa/build-bspv422/build-system-3/toolchain/nds32le-elf-mculib-v3s/nds32le-elf/lib");
SECTIONS
{
  /* Read-only sections, merged into text segment: */
  PROVIDE (__executable_start = 0x300000); . = 0x300000;
